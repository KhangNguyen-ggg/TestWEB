...
webbt_fullstack/
├── backend/
│   ├── api/                 <-- Đổi tên từ thư mục "routes" cũ
│   │   ├── admin.js, auth.js, cart.js, orders.js, products.js, auth-mw.js, shape.js, pages.php
│   ├── db/
│   │   ├── database.php, db.js, init-db.js, schema.sql, seed.sql, website_vnpt.sql
│   └── server.js
├── frontend/
│   ├── assets/              <-- Chứa hình ảnh, CSS, fonts
│   │   ├── images/, style.css
│   ├── components/          <-- Chứa các file mảnh ghép (header, footer, body)
│   │   ├── header.php, footer.php, body.php
│   ├── js/                  <-- Chứa các file logic JS (api.js, cart.js, chat.js, main.js, pages.js, auth.js, admin.js, carousel.js)
│   └── index.php            <-- File gốc nằm ngoài cùng

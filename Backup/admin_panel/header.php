<?php
// Trỏ ra thư mục frontend để lấy config chung
...
<head>
    ...
    <!-- Khai báo API URL cho Javascript -->
    <script>const GLOBAL_API_URL = "<?= API_URL ?>";</script>
    
    <!-- Load api.js CỦA FRONTEND VÀO ĐÂY LUÔN -->
    ...
    <div class="sidebar-nav">
        ...
        <a href="products.php"
           class="sidebar-link <?= $activeMenu === 'products' ? 'active' : '' ?>">
            <i class="fa-solid fa-box-open"></i> Sản phẩm & Dịch vụ
        </a>
